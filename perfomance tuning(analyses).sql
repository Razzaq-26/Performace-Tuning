-- first identify the what type of index a table have if we know the query on the database, 
...
-- degree of parallelisum (depence)
    ...
    select * from dbo.votes option (maxdop 6)
...
-- enable cardinality estimationmodel version
